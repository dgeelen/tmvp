...
const WINDOW_SIZE = (1 << 15)-1;
const COPYLEN_SIZE = (1 << 8)-1;
const SKIPLEN_SIZE = (1 << 7)-1;

/*
1xxx xxxx
	-> copy x literals from encoded stream
0xxx xxxx xxxx xxxx yyyy yyyy
	-> copy y bytes from decoded stream starting at offset x
16 bits output
...
void LZ77_compress2(string infile, string outfile)
{
